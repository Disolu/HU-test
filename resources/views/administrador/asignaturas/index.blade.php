...
@section('cuerpo')
	...
	<section class="panel">
		<header class="panel-heading">
			<h2 class="panel-title">Registrar Asignaturas</h2>
		</header>
		<div class="panel-body">
			...
			{!! Form::token() !!}
				<div class="form-group">
					...
					<div class="col-md-6">
						<input name="nombre" class="form-control input-sm mb-md" type="text" placeholder="Nombre de la Asignatura">
						<fieldset>
							<div class="form-group">
	...
	<section class="panel">
		<header class="panel-heading">
			<h2 class="panel-title">Asignaturas Registrados</h2>
		</header>
		<div class="panel-body">
			<div class="row">
				<div class="col-md-12">
