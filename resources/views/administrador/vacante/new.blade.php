...
@section('cuerpo')
	...
	<section class="panel">
		<header class="panel-heading">
			<h2 class="panel-title">Nuevas Vacantes</h2>
		</header>
		<div class="panel-body">
			@include('alertas.request')
			@include('alertas.success')
			{!! Form::open(['route' => 'vacantenew', 'method' => 'post']) !!}
			{!! Form::token() !!}	
				<div class="form-group">
					<label class="col-md-3 control-label" for="inputSuccess"></label>
					<div class="col-md-6">				
						{!! Form::number('qty_vacantes', null, ['class' => 'form-control input-sm mb-md', 'placeholder' => 'Cantidad de vacantes']) !!}
